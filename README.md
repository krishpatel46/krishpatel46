# 💫 About Me:
👋 My name is Krish Patel (aka, Kris😉).<br>🌱 Currently pursuing B.Tech in Information Technology.<br>👀 I am a Mobile Application Developer and an AI/ML enthusiast.<br>⏩ Skilled in various OOP languages: Java, C++, and Python.<br>💻 Created numerous mobile applications using Android SDK and Firebase Firestore integration.<br>📢 Currently working on a project to learn and implement ML concepts and models.<br>🎧 Melophile here. 💖 The Weeknd.
...
![](https://nirzak-streak-stats.vercel.app/?user=krishpatel46&theme=codeSTACKr&hide_border=false)<br/>
